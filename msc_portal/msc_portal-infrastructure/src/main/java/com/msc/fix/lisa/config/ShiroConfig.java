...
import com.msc.fix.lisa.common.OAuth2Filter;
import com.msc.fix.lisa.common.OAuth2Realm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/api/webjars/**", "anon");
        filterMap.put("/api/druid/**", "anon");
        filterMap.put("/api/app/**", "anon");
        filterMap.put("/api/sys/login", "anon");
        filterMap.put("/api/swagger/**", "anon");
        filterMap.put("/api/v2/api-docs", "anon");
        filterMap.put("/api/swagger-ui.html", "anon");
