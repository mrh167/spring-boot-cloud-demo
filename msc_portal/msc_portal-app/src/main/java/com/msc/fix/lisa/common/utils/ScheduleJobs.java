...
import com.msc.fix.lisa.domain.common.utils.SpringContextUtils;
...
public class ScheduleJobs extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
			...
			ScheduleJobLogCo jobLogCo = BeanUtils.convert(log, ScheduleJobLogCo.class);
			scheduleJobLogService.save(jobLogCo);
		}
    }
}
