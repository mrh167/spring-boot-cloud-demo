...
package com.msc.fix.lisa.controller.quratz;
...
public class ScheduleJobController {
	...
	public R info(@PathVariable("jobId") Long jobId){
		ScheduleJobCo schedule = scheduleJobService.getByIds(jobId);
	...
	public R save(@RequestBody ScheduleJobCo scheduleJob){
	...
	public R update(@RequestBody ScheduleJobCo scheduleJob){
		ValidatorUtils.validateEntity(scheduleJob);
