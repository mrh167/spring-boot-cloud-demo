package com.msc.fix.lisa.mybatiscn.configurer;
...
public class GeneratorConfigruation {
    ...
    public static GeneratorConfig generatorConfig(){
        GeneratorConfig config = GeneratorConfig.builder()
                .jdbcUrl("jdbc:mysql://localhost:3306/marry_pub?characterEncoding=utf-8&autoReconnect=true&useSSL=false&serverTimezone=Asia/Shanghai")
                .userName("root")
                .password("root")
