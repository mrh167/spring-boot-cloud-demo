...
public class BeetlTemplateEngine extends AbstractTemplateEngine {
    ...
    public BeetlTemplateEngine(String templateStoreDir) {
        ...
        try {
            ...
            loader.addResourceLoader(new StartsWithMatcher(Constant.RESOURCE_PREFIX_CLASSPATH).withoutPrefix(), classpathResourceLoader);
            loader.addResourceLoader(new StartsWithMatcher(Constant.RESOURCE_PREFIX_FILE).withoutPrefix(), fileResourceLoader);
