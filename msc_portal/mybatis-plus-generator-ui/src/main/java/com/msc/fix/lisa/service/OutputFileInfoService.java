...
import com.msc.fix.lisa.dto.OutputFileInfo;
...
public class OutputFileInfoService {
    ...
    public List<OutputFileInfo> getBuiltInFileInfo() {
        ...
        entityFile.setFileType(Constant.FILE_TYPE_ENTITY);
        ...
        mapperXmlFile.setFileType(Constant.FILE_TYPE_MAPPER_XML);
        ...
        mapperFile.setFileType(Constant.FILE_TYPE_MAPPER);
        ...
        serviceFile.setFileType(Constant.FILE_TYPE_SERVICE);
        ...
        serviceImplFile.setFileType(Constant.FILE_TYPE_SERVICEIMPL);
        ...
        controllerFile.setFileType(Constant.FILE_TYPE_CONTROLLER);
