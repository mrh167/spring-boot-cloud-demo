...
```xml
 <dependency>
    <groupId>com.msccom.msc</groupId>
...
public class GeberatorUIServer {
    ...
    public static void main(String[] args) {
        GeneratorConfig config = GeneratorConfig.builder().jdbcUrl("jdbc:mysql://127.0.0.1:3306/example")
                .userName("root")
                .password("root")
                ...
                .basePackage("com.msc.mybatisplustools.example")
                .port(8068)
                .build();
